...
const Endpoints = {
    Raw: function (path) {
        return "http://quanlydaotao.tump.edu.vn/" + path;
    },
    Make: function (endpoint) {
        return Endpoints.Raw("dhyd/" + endpoint);
    }
};
...
module.exports = function () {
    this["Name"] = "TUMP";
    this["Title"] = "Trường Đại học Y Dược Thái Nguyên";
    this["Description"] = "TUMP";
    ...
    this.GetMarkTable = function () {
        return new Promise(function (resolve, reject) {
            base.Get(Endpoints.Make(__URLTOKEN__ + "StudentMark.aspx")).then(function (resp) {
                ...
                tb.tongsotc = "0";
                tb.sotctuongduong = arrTTDIemTB[6];
                tb.stctln = arrTTDIemTB[3];
                tb.dtbc = arrTTDIemTB[4];
                tb.dtbcqd = arrTTDIemTB[5];
                tb.somonkhongdat = "0";
                tb.sotckhongdat = "0";
                tb.dtbxltn = "0";
                tb.dtbmontn = "0";
...
module.exports["Name"] = "TUMP";
module.exports["Title"] = "Trường Đại học Y Dược Thái Nguyên";
module.exports["Description"] = "TUMP";
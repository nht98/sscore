...
const Endpoints = {
    Raw: function (path) {
        return "http://daotao.tnu.edu.vn/" + path;
    },
    Make: function (endpoint) {
        return Endpoints.Raw("knn/" + endpoint);
    }
};
...
module.exports["Name"] = "SFL";
module.exports["Title"] = "Trường Đại học Ngoại Ngữ Thái Nguyên";
module.exports["Description"] = "SFL";